...
import 'package:base/src/navi.dart';
...
class HpDevice {
  ...
  static double screenSizeToPixel(BuildContext c, double d) =>
      d * MediaQuery.of(c).devicePixelRatio * (HpPlatform.isMac() ? 1.5 : 1);
